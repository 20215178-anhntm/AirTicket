...
{
    std::cout << "1. Search based on company, departure point, destination point\n";
    std::cout << "2. Search based on departure point, destination point, departure date\n";
    std::cout << "3. Search based on departure point, destination point, departure date, return date\n";
    std::cout << "4. Search based on company, departure point, destination point, departure date, return date\n";
    std::cout << "5. Exit\n";
